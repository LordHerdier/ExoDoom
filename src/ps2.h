 ...
 * link target (src/libos_wad_viewer/libos_wad_viewer.c) that includes this
 * header for the ps2_key_t enum alone -- KEY_LEFT/KEY_RIGHT for automap
 * navigation -- is compiled WITHOUT -DEXO_KERNEL, and without this guard the
 * two same-named, differently-typed declarations would conflict. */
#ifdef EXO_KERNEL
