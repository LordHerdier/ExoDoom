 ...
 * past the last number — and the spec's total is 23 syscalls (SCRUM-168). */
static void test_count_is_one_past_last(void)
{
    CU_ASSERT_EQUAL(EXO_SYS_COUNT, EXO_SYS_LAUNCH_CLOCK + 1);
...
static void test_numbers_are_unique(void)
{
    static const int numbers[] = {
        ...
        EXO_SYS_LAUNCH_WAD_VIEWER, EXO_SYS_LAUNCH_CLOCK,
    };
