...
_Static_assert(TEST_OWNER_VMM_REGISTRY     != TEST_OWNER_VMM_ADDRSPACE &&
              ...
              TEST_OWNER_VMM_REGISTRY     != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_VMM_ADDRSPACE    != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_LIBOS_LAUNCH     != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_LIBOS_MAIN       != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_LIBOS_C_PROBE    != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_PORT_IO_FAULT    != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_KERNEL_MEM_FAULT != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_IRQ_ENTRY        != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_SSE              != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_REVOKE_ADDRSPACE != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_SYSCALL_BENCH    != TEST_OWNER_VMM_QUOTA &&
              TEST_OWNER_VMM_REGISTRY     != TEST_OWNER_SOUND &&
              TEST_OWNER_VMM_ADDRSPACE    != TEST_OWNER_SOUND &&
              TEST_OWNER_LIBOS_LAUNCH     != TEST_OWNER_SOUND &&
              TEST_OWNER_LIBOS_MAIN       != TEST_OWNER_SOUND &&
              TEST_OWNER_LIBOS_C_PROBE    != TEST_OWNER_SOUND &&
              TEST_OWNER_PORT_IO_FAULT    != TEST_OWNER_SOUND &&
              TEST_OWNER_KERNEL_MEM_FAULT != TEST_OWNER_SOUND &&
              TEST_OWNER_IRQ_ENTRY        != TEST_OWNER_SOUND &&
