...
| **Sprint 13: Harden + Compat Test**                     | Hardening                                | Regression suite ⬜ SCRUM-114, fuzz testing syscalls ⬜ SCRUM-115, test with DOOM.WAD / DOOM2.WAD / Freedoom2 ⬜ SCRUM-116, performance report ⬜ SCRUM-117, code cleanup ⬜ SCRUM-119                                                                                                                                                                                                                                                                                                       |
...
| SCRUM-146 Audio | To Do | PC speaker driver, SFX mapping, `exo_sound_play` (SCRUM-98–101) — untouched |
...
| SCRUM-148 Testing, CI & Isolation | Mostly to do, one piece done | CI pipeline ✅ SCRUM-120 (Docker build + QEMU boot + serial suite on push); regression/fuzz/compat suites (SCRUM-58–60, 114–116) still open |
